#!/bin/bash -e
#
# $Id: build-updates.sh 18981 2022-10-02 00:56:46Z NiLuJe $
#
...
kindletool create ota2 "${KT_PM_FLAGS[@]}" -d paperwhite2 -d basic -d voyage -d paperwhite3 -d oasis -d basic2 -d oasis2 -d paperwhite4 -d basic3 -d oasis3 -d paperwhite5 -d scribe libotautils5 install.sh ${HACKNAME}.tar.xz xzdec ${HACKNAME}.conf Update_${PKGNAME}_${PKGVER}_install_pw2_and_up.bin
